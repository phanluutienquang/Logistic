...
class User extends BaseModel
{
     ...
     */
    public static function detail($userId, $with = ['user', 'referee','rating'])
    {
    ...
    {
        $model = new static;
        return !!$model->where('rating_id', '=', (int)$gradeId)
            ->where('is_delete', '=', 0)
            ->value('user_id');
    }
    ...
    public function rating()
    {
        ...
        return $this->belongsTo("app\\{$module}\\model\\dealer\\Rating");
    }
