<?php
namespace app\web\service\master\order;

use app\web\service\Basics;
use app\common\library\helper;
use app\web\model\dealer\Apply as DealerApplyModel;

/**
 * 普通订单支付成功后的回调
 * Class PaySuccess
 * @package app\web\service\master\order
 */
