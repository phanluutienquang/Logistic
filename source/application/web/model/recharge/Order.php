...
namespace app\web\model\recharge;

use app\common\model\recharge\Order as OrderModel;

use app\web\model\Setting as SettingModel;
use app\web\model\recharge\Plan as PlanModel;
use app\web\model\recharge\OrderPlan as OrderPlanModel;
 ...
 * 用户充值订单模型
 * Class Order
 * @package app\web\model\recharge
 */
class Order extends OrderModel
{
    ...
    /**
     * 创建充值订单
     * @param \app\web\model\User $user 当前用户信息
