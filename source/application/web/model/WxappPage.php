...
use app\web\model\sharing\Goods as SharingGoodsModel;
use app\web\model\bargain\Active as BargainActiveModel;
use app\web\service\sharp\Active as SharpActiveService;
...
class WxappPage extends WxappPageModel
{
    ...
    private function getGoodsList($user, $item)
    {
        ...
        if ($item['params']['source'] === 'choice') {
            ...
            $goodsList = $model->getListByIdsFromweb($goodsIds, $user);
        } else {
            // 数据来源：自动
