<div class="card">
    <div class="card-header border bottom">
        <h4 class="card-title">收件人地址</h4>
    </div>
    <div class="card-body">
        <div class="" style="margin-bottom:10px;">
            <span style="padding: 13px 18px;" onclick="window.location.href='<?=urlCreate('/web/package/addAddress') ?>'" data-toggle="modal" data-target="#basic-modal" class="badge badge-primary">新增收件人</span>
        </div>
