...
class Withdraw extends Controller
{
     ...
     */
    public function index($shop_id = null, $apply_status = -1, $pay_type = -1, $search = '')
    {
        $model = new WithdrawModel;
       
        return $this->fetch('index', [
            'list' => $model->getList($shop_id, $apply_status, $pay_type, $search)
        ]);
    }
