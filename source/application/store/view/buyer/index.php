                    ...
                    <div class="page_toolbar am-margin-bottom-xs am-cf">
                     ...
                     <div class="am-form-group am-fl">
                           <div class="page_toolbar am-margin-bottom-xs am-cf" style="margin-bottom:20px; margin-left:15px;">
                             <button type="button" id="j-upstatus" class="am-btn am-btn-success am-radius">批量修改</button>
                         ...
                         tpl-table-black am-text-nowrap">
                            ...
                            <tbody id="body">
                             <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                ...
                                <tr>
                                    <td><input name="checkIds" type="checkbox" value="<?= $item['b_order_id'] ?>" ></td>
                                    ...
                                    <td>购买链接 :<a href="<?= $item['url'] ?>" target="_blank">点击链接购买</a></br> 
                                    ...
                                    <td><?php if($item['status']>2): ?>快递单号-<?= $item['express_num']; ?></br>物流名称-<?= $item['express_name']; ?><?php else: ?>未发货<?php endif ;?></td>
                                    <!--<td><?= $item['reason']??'' ?> - <?= $item['remark']??'' ?> - <?= $item['feedback']??'' ?></td>-->
                                    <td><?= $status[$item['status']]; ?><?php if($item['status']==-1 || $item['status']==8): ?><br/><span style="color:#ff6600;">已退款(不含服务费)<?=$item['total_free']; ?>元 <br/>
                                        已退服务费 <?=$item['refund_service']; ?>元</span><?php endif; ?></td>
                                    ...
                                    <td class="am-text-middle">
                                          ...
                                          <a href="<?= url('store/buyer/update', ['id' => $item['b_order_id']]) ?>">
            ...
            <div class="am-tab-panel am-padding-0 am-active">
               <div class="am-form-group">
                ...
                <div class="am-form-group">
                    ...
                    <div class="am-u-sm-8 am-u-end">
                          <select name="order[status]"
                                data-am-selected="{btnSize: 'sm', placeholder: '请选择'}">
