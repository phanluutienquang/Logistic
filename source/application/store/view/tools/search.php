...
<div class="main_section_agile">
		<div class="agileits_w3layouts_banner_nav">
			...
			<nav class="navbar navbar-default">
				...
				<h1>
				    <a class="navbar-brand" href="/index.php?s=/store/tools/search"><i class="fa fa-plane" aria-hidden="true"></i> <?= $setting['name'] ;?> </a></h1>
...
<script>
 var url = "<?php echo('/index.php/store/track/search') ?>";
 $(".btn").click(res=>{
