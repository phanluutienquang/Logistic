                ...
                <form id="my-form" class="am-form tpl-form-line-form" method="post">
                    <div class="widget-body">
                        <fieldset>
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">集运路线 </label>
                                <div class="am-u-sm-9 am-u-end am-padding-top-xs">
                                    <small class="am-text-sm"><?= $model['order_m']['linedata']['name'] ?></small>
                                </div>
                            </div>
                            ...
                            <div class="am-form-group am-margin-top-xl">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="comment[speed]" value="5" data-am-ucheck
                                            <?= $model['score']['speed'] >= 4 ? 'checked' : '' ?> >
                                        好评
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="comment[speed]" value="3" data-am-ucheck
                                            <?= $model['score']['speed'] == 3 ? 'checked' : '' ?> >
                                        中评
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="comment[speed]" value="2" data-am-ucheck
                                            <?= $model['score']['speed'] <3 ? 'checked' : '' ?> >
                                        差评
                                    </label>
                                </div>
                            ...
                            <div class="am-form-group am-margin-top-xl">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="comment[service]" value="5" data-am-ucheck
                                            <?= $model['score']['service'] >= 4 ? 'checked' : '' ?> >
                                        好评
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="comment[service]" value="3" data-am-ucheck
                                            <?= $model['score']['service'] == 3 ? 'checked' : '' ?> >
                                        中评
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="comment[service]" value="2" data-am-ucheck
                                            <?= $model['score']['service'] <3 ? 'checked' : '' ?> >
                                        差评
                                    </label>
                                </div>
