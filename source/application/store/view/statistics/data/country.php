        ...
        <div class="am-u-sm-12 am-margin-bottom">
            <div class="widget-ranking widget am-cf">
                <div class="widget-head">
                    <div class="widget-title">目的地排行榜</div>
                </div>
                    ...
                    <table width="100%" class="am-table am-table-compact am-table-striped
                        ...
                        <tr v-for="(item, index) in countryRanking">
                            ...
                            <td class="am-text-middle">
                                <p class="ranking-item-title am-text-truncate">{{ item.title }}</p>
                            </td>
...
<script type="text/javascript">
    ...
    new Vue({
        el: '#app',
        data: {
            countryRanking: <?= \app\common\library\helper::jsonEncode($countryRanking) ?>,
        },
