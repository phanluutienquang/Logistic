                            ...
                            <?php if (!$list->isEmpty()): foreach ($list as $item): ?>
                                <tr>
                                    ...
                                    <td class="am-text-middle">
                                            <span class="am-badge am-badge-<?= $item['status']==1 ? 'success' : 'warning' ?>">
                                               <?= $item['status']==1 ? '通过' : ($item['status']==0?'审核中':'拒绝') ?>
                                           </span>
                                    </td>
                                    <td class="am-text-middle"><?= $item['create_time'] ?></td>
                                    <td class="am-text-middle">
                                        <div class="tpl-table-black-operation">
                                            <?php if (checkPrivilege('shop.apply/edit')): ?>
                                                <a href="<?= url('shop.apply/edit', ['shop_id' => $item['id']]) ?>">
                                            ...
                                            <?php elseif ($item['status'] == 2) : ?>
                                                <a class="j-show-reason tpl-table-black-operation-green"
                                                   ...
                                                   data-reason="<?= $item['reason'] ?>">
                                                    驳回原因</a>
                                            <?php endif; ?>
                                            <?php if (checkPrivilege('shop.apply/delete')): ?>
            ...
            <div class="am-form-group">
                ...
                <div class="am-u-sm-9">
                    <label class="am-radio-inline">
                        <input type="radio" name="apply[status]" value="1" data-am-ucheck
                               checked> 审核通过
                    </label>
                    <label class="am-radio-inline">
                        <input type="radio" name="apply[status]" value="2" data-am-ucheck> 驳回
                    </label>
                </div>
            </div>
            <div class="am-form-group">
                ...
                <div class="am-u-sm-9">
                    <input type="text" class="tpl-form-input" name="apply[reason]" placeholder="仅在驳回时填写"
                           value="">
                </div>
            </div>
        </form>
