                            ...
                            <div class="am-tabs-bd">
                                <div class="am-tab-panel am-active am-margin-top-lg" id="tab1">
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label form-require"> 是否开启加盟功能 </label>
                                        <div class="am-u-sm-9">
                                ...
                                <div class="am-tab-panel am-margin-top-lg" id="tab2">
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label form-require"> 成为加盟商条件 </label>
                                        <div class="am-u-sm-9">
                                            <label class="am-radio-inline">
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            ...
                                            <div class="help-block">
                                                <small>注：如使用微信支付，则需申请微信支付企业付款到零钱功能；微信好友转账为加申请提现者为好友进行私下转账</small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                    ...
                                    <div class="am-form-group am-padding-top">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="number" min="0" class="tpl-form-input"
                                                   ...
                                                   required>
                                            <div class="help-block">
                                                <small>当订单完成n天后，该订单的加盟分成才会结算到加盟商余额，如果设置为0天 则订单完成时就结算</small>
                                            </div>
                                            <div class="help-block">
                                                <small>注：建议分成结算天数大于允许发起售后申请天数，如果用户申请售后退款，则不结算分成</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="am-tab-panel" id="tab5">
                                    <div class="widget-head am-cf">
                                        <div class="widget-title am-fl">加盟中心页面</div>
                                    </div>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label form-require">
                                            页面标题
                                    ...
                                    <div class="widget-head am-cf">
                                        <div class="widget-title am-fl">申请成为加盟商页面</div>
                                    </div>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label form-require">
                                            页面标题
                                    ...
                                    <div class="widget-head am-cf">
                                        <div class="widget-title am-fl">加盟订单页面</div>
                                    </div>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label form-require">
                                            页面标题
                                    ...
                                    <div class="widget-head am-cf">
                                        <div class="widget-title am-fl">我的仓库页面</div>
                                    </div>
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-form-label form-require">
                                            页面标题
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input"
                                                   name="setting[words][shop][title][value]"
                                                   value="<?= $data['words']['values']['shop']['title']['value'] ?>"
                                                   required>
                                            <small>
                                                默认：<?= $data['words']['values']['shop']['title']['default'] ?></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="am-form-group">
                                        ...
                                        <div class="am-u-sm-9">
                                            <input type="text" class="tpl-form-input"
                                                   name="setting[words][withdraw_apply][words][txmx][value]"
                                                   value="<?= $data['words']['values']['withdraw_apply']['words']['txmx']['value'] ?>"
                                                   required>
                                        </div>
                                    </div>
                                    <div class="am-form-group">
                                ...
                                <div class="am-tab-panel am-margin-top-lg" id="tab6">
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">加盟商申请协议 </label>
                                        <div class="am-u-sm-9 am-u-end">
                                    <textarea class="" rows="6" placeholder="请输入加盟商申请协议"
                                ...
                                <div class="am-tab-panel am-margin-top-lg" id="tab7">
                                    ...
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">加盟中心首页 </label>
                                        <div class="am-u-sm-9 am-u-end">
                                    ...
                                    <div class="am-form-group">
                                        <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">申请成为加盟商页 </label>
                                        <div class="am-u-sm-9 am-u-end">
                                            <div class="am-form-file">
                                                <div class="am-form-file">
                                                    <button type="button"
