                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">盲盒分享详情</div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end am-padding-top-xs">
                                    <textarea class="am-field-valid" rows="5" placeholder="请输入评价内容"
                                              name="blindbox[content]" required><?= $model['content'] ?></textarea>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">分享图片 </label>
                                        ...
                                        <div class="uploader-list am-cf">
                                            <?php foreach ($model['image'] as $key => $item): ?>
                                                <div class="file-item">
                                                    ...
                                                    <input type="hidden" name="blindbox[images][]"
                                                           value="<?= $item['image_id'] ?>">
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label form-require">分享排序 </label>
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="number" min="0" class="tpl-form-input" name="blindbox[sort]"
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="blindbox[status]" value="1" data-am-ucheck
                                            <?= $model['status'] == 1 ? 'checked' : '' ?> >
                                        显示
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="blindbox[status]" value="0" data-am-ucheck
                            ...
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">分享时间 </label>
                                <div class="am-u-sm-9 am-u-end am-padding-top-xs">
