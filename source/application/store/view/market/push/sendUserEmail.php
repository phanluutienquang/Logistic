                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">发送邮件通知消息</div>
                            </div>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <div class="widget-become-goods am-form-file am-margin-top-xs">
                                        ...
                                        <div class="am-block">
                                            <small>选择要你要发邮件的对象</small>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="am-form-group">
                                <label class="am-u-sm-3 am-u-lg-2 am-form-label">邮件内容</label>
                                <div class="am-u-sm-9 am-u-end wd">
                                    <input type="text" class="tpl-form-input" name="sendsms[content]"
                                           value="<?= $data['remark']??'' ;?>" placeholder="邮件内容" >
                                </div>
                            </div>
                            <div class="am-form-group">
