                    ...
                    <div class="widget-body">
                        <fieldset>
                            <div class="widget-head am-cf">
                                <div class="widget-title am-fl">编辑货币</div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="currency[currency_name]"
                                           value="<?= $model['currency_name']?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="currency[currency_symbol]"
                                           value="<?= $model['currency_symbol']?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="currency[currency_en]"
                                           value="<?= $model['currency_en']?>" required>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <input type="text" class="tpl-form-input" name="currency[exchange_rate]"
                                           value="<?= $model['exchange_rate']?>" required>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="currency[status]" value="0" data-am-ucheck <?= $model['status'] == 0 ? 'checked' : '' ?>>
                                        启用
                                    </label>
                                     <label class="am-radio-inline">
                                        <input type="radio" name="currency[status]" value="1" data-am-ucheck <?= $model['status'] == 1 ? 'checked' : '' ?>>
                                        禁用
                                    </label>
                                </div>
                            </div>
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="currency[is_default]" value="0" data-am-ucheck <?= $model['is_default'] == 0 ? 'checked' : '' ?>>
                                        非默认
                                    </label>
                                     <label class="am-radio-inline">
                                        <input type="radio" name="currency[is_default]" value="1" data-am-ucheck <?= $model['is_default'] == 1 ? 'checked' : '' ?>>
                                        默认
                                    </label>
                                </div>
                            </div>
