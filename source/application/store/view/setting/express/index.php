                    ...
                    <div class="am-u-sm-12 am-u-md-6 am-u-lg-6">
                        <div class="am-form-group">
                            <div class="am-btn-toolbar">
                                ...
                                <?php endif; ?>
                                <?php if (checkPrivilege('setting.express/copy')): ?>
                                    <div class="am-btn-group am-btn-group-xs">
                                        <button type="button" id="j-copycontry" class="am-btn am-btn-warning am-radius">导入基础物流公司</button>
                                    </div>
                                <?php endif; ?>
                            </div>
...
<script>
    $(function () {
        ...
        $('#j-copycontry').on('click', function () {
            $.ajax({
                type:"POST",
                url:'<?= url('store/setting.express/copy') ?>',
                data:{},
                dataType:"JSON",
