                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9 am-u-end">
                                    <label class="am-radio-inline">
                                        <input type="radio" name="category[is_hot]" value="0" data-am-ucheck checked>
                                        非热门
                                    </label>
                                    <label class="am-radio-inline">
                                        <input type="radio" name="category[is_hot]" value="1" data-am-ucheck>
                                        热门
                                    </label>
                                    <div class="help-block"><small>热门分类在仓管端可以快速选择</small></div>
                                </div>
                            </div>
                            <div class="am-form-group">
